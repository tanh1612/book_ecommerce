...
source: mysqldump --no-data book_ecommerce (after migrate:fresh)
---

-- Host: 127.0.0.1
-- Server version: 8.4.3 - MySQL Community Server
-- Structure-only; password_reset_tokens removed; payment_transactions + CHECK constraints included.
